...
export default function FaultyTerminal({
  ...
  style,
  ...rest
}: FaultyTerminalProps & Omit<React.HTMLAttributes<HTMLDivElement>, keyof FaultyTerminalProps>) {
  ...
  const ditherValue = useMemo(
    () => (typeof ditherProp === 'boolean' ? (ditherProp ? 1 : 0) : ditherProp),
    [ditherProp]
  );
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      const res = program.uniforms.iResolution.value as number[];
      if (res && res.length >= 3) {
